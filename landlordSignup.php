...
<div class="w-full flex flex-col justify-center items-center">
    ...
    <main class="flex items-center justify-center gap-8 px-8 w-full max-w-lg pb-4 mb-4">
        <div class=" flex flex-col items-center">
            ...
            <form class="space-y-4 flex flex-col w-full gap-4" method="POST" action="Controllers/LandlordsSignupController.php">
                <div class="flex flex-col md:flex-row w-full justify-center items-center gap-4">
                    <div class="flex flex-col gap-2 w-full">
                        ...
                        <input type="text" class="w-full p-2 border border-gray-300 rounded-md placeholder:font-light placeholder:text-gray-500" name="fname" id="fname" placeholder="First Name" value="<?php echo htmlspecialchars($formData['fname'] ?? ''); ?>">
                    ...
                    <div class="flex flex-col gap-2 w-full">
                        ...
                        <input type="text" class="w-full p-2 border border-gray-300 rounded-md placeholder:font-light placeholder:text-gray-500" name="lname" id="lname" placeholder="Last Name" value="<?php echo htmlspecialchars($formData['lname'] ?? ''); ?>">
                ...
                <div class="flex flex-col md:flex-row w-full justify-center items-center gap-4">
                    <div class="flex flex-col gap-2 w-full">
                        ...
                        <input type="email" class="w-full p-2 border border-gray-300 rounded-md placeholder:font-light placeholder:text-gray-500" name="email" id="email" placeholder="johndoe@gmail.com" value="<?php echo htmlspecialchars($formData['email'] ?? ''); ?>">
                    ...
                    <div class="flex flex-col gap-2 w-full">
                        ...
                        <input type="text" class="w-full p-2 border border-gray-300 rounded-md placeholder:font-light placeholder:text-gray-500" name="address" id="address" placeholder="Poblacion 4, Taal, Batangas" value="<?php echo htmlspecialchars($formData['address'] ?? ''); ?>">
                ...
                <div class="flex flex-col gap-2">
                    <label for="phone" class="text-sm font-medium leading-none">Business Property Name</label>
                    <input class="w-full p-2 border border-gray-300 rounded-md placeholder:font-light placeholder:text-gray-500" id="property_name" name="property_name" type="text" placeholder="Poblacion Rental" value="<?php echo htmlspecialchars($formData['property_name'] ?? ''); ?>">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input class="w-full p-2 border border-gray-300 rounded-md placeholder:font-light placeholder:text-gray-500" id="phone" name="phone" type="tel" maxlength="11" placeholder="09756656378" value="<?php echo htmlspecialchars($formData['phone'] ?? ''); ?>">
                    <?php if (isset($errors['phone'])): ?>
                        <p class="text-red-500 text-sm"><?php echo htmlspecialchars($errors['phone']); ?></p>
                    <?php endif; ?>
                </div>
