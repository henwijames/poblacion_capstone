...
if (isset($_GET['id'])) {
    $tenantId = $_GET['id'];
    $result = $tenants->declineTenant($tenantId);
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <p>Your account has been declined based on your <span style="font-weight: bold;">Valid ID</span> submission please upload clear and authentic Valid ID. Thank you for being part of PoblacionEase!</p>
