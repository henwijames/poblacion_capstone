        ...
        <section class="w-full overflow-hidden bg-background">
            <div class="flex flex-col">
                ...
                <div class="sm:w-[80%] xs:w-[90%] mx-auto flex flex-col items-center -mt-16">
                    <img src="<?php echo !empty($landlord['profile_picture']) ? '../landlords/Controllers/' . htmlspecialchars($landlord['profile_picture']) : '../assets/img/me.jpg'; ?>" alt="User Profile"
                    ...
                    <h1 class="w-full text-center  md:my-2 my-6 text-primary font-bold text-2xl sm:text-3xl lg:text-4xl">
                        <div class="flex flex-col sm:flex-row justify-center items-center gap-4 my-6">
                            <h1 class="text-center text-primary text-2xl sm:text-3xl lg:text-4xl">
                                <?php echo htmlspecialchars($landlord['first_name']) . " " . htmlspecialchars($landlord['middle_name']) . " " . htmlspecialchars($landlord['last_name']) ?>
                            </h1>
                        ...
                        <div class="w-full">
                            <dl class="text-gray-900 divide-y divide-gray-200  ">
                                <div class="flex flex-col pb-3">
                                    ...
                                    <dd class="text-lg font-semibold"><?php echo htmlspecialchars($landlord['first_name']); ?></dd>
                                </div>
                                <div class="flex flex-col pb-3">
                                ...
                                <div class="flex flex-col pt-3">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="badge text-sm inline-flex items-center capitalize text-white
                                            ...
                                            <?php echo (!$landlord['mobile_verified'] == '1') ? 'Not verified' : 'Verified'; ?>
                                        </span>
                                    </div>
                                </div>
                                <div class="flex flex-col pt-3">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="badge text-sm inline-flex items-center capitalize text-white
                                            ...
                                            <?php echo (!$landlord['email_verified'] == '1') ? 'Not verified' : 'Verified'; ?>
                                        </span>
                                    </div>
                            </dl>
                        </div>
