...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($tenant['verification_code'] === $code && strtotime($tenant['verification_expires_at']) > time()) {
        ...
        $tenants->verifyEmailAddress($user_id);

        $_SESSION['success'] = "Email Address verified successfully!";
        ...
        <div class="p-6">
            <div class="container mx-auto h-full flex items-center justify-center">
                <div class="flex flex-col items-center justify-center gap-4 py-12">
                    <h1 class="text-4xl text-primary font-bold">Enter OTP from Email Address</h1>
                    <p class="text-center text-muted-foreground">Please verify your account to continue.</p>
                    <div class=" p-8 rounded-lg  w-96">
                        <form id="otpForm" class="space-y-4" method="POST" action="verify-email.php">
