...
<div class="w-full flex flex-col justify-center items-center">
    ...
    <main class="flex items-center justify-center gap-8 px-8 w-full max-w-lg pb-4 mb-4">
        <div class=" flex flex-col items-center">
            <h1 class="text-4xl font-bold text-center mb-6">Sign up as a <span class="text-primary">Admin</span></h1>
            <form class="space-y-4 flex flex-col w-full gap-4" method="POST" action="Controllers/AdminsSignupController.php">
