...
<header class="home min-h-screen">
    ...
    <main class="flex flex-col justify-center items-center gap-y-7 ">
        ...
        <div class="flex flex-col md:flex-row gap-4">
            <a href="forgot_landlord" class="bg-white p-8 rounded-lg w-[200px] h-[200px] md:w-[400px] md:h-[400px] shadow-lg flex flex-col items-center justify-center hover:bg-[#DEE197] transition-all ease focus:ring-2 focus:ring-[#C1C549]">
                <img src="assets/img/landlord.png" alt="landlord" class="w-full h-full mb-2">
                <h1 class="font-semibold text-lg">Landlord</h1>
            </a>
            <a href="forgot_tenant" class="bg-white p-8 rounded-lg w-[200px] h-[200px] md:w-[400px] md:h-[400px] shadow-lg flex flex-col items-center justify-center hover:bg-[#DEE197] transition-all ease focus:ring-2 focus:ring-[#C1C549]">
